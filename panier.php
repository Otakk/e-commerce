...
?>
            ...
            <div class="container col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 mx-auto d-flex justify-content-center shadow-sm px-0">
                <div class="col-md-2 bg-white p-2">
                    <a href="fiche_produit.php"><img src="assets/img/tee-shirt1.jpg" alt="produit 1" class="img-panier"></a>
                </div>
                <div class="col-md-6 bg-white d-flex flex-column justify-content-center p-2">
                    <h4><a href="fiche_produit.php" class="alert-link text-dark titre-produit-panier">Tee-shirt h/f</a></h4>
            ...
            <div class="container col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 mx-auto d-flex justify-content-center shadow-sm px-0 mt-2">
                <div class="col-md-2 bg-white p-2">
                    <a href="fiche_produit.php"><img src="assets/img/tee-shirt2.jpg" alt="produit 1" class="img-panier"></a>
                </div>
                <div class="col-md-6 bg-white d-flex flex-column justify-content-center p-2">
                    <h4><a href="fiche_produit.php" class="alert-link text-dark titre-produit-panier">Tee-shirt noir</a></h4>
                    <p class="text-success fw-bold fst-italic">En stock !</p>
                    <p>Quantité : 3</p>
                    <p class="mb-0"><a href="" class="alert-link text-dark liens-supp-produit-panier">Supprimer</a></p>
                </div>
            ...
            <div class="container col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 mx-auto d-flex justify-content-center shadow-sm px-0 mt-2">
                <div class="col-md-2 bg-white p-2">
                    <a href="fiche_produit.php"><img src="assets/img/tee-shirt3.jpg" alt="produit 1" class="img-panier"></a>
                </div>
                <div class="col-md-6 bg-white d-flex flex-column justify-content-center p-2">
                    <h4><a href="fiche_produit.php" class="alert-link text-dark titre-produit-panier">Tee-shirt violet</a></h4>
