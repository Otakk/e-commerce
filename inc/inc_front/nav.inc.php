                    ...
                    <div class="collapse navbar-collapse" id="navbarsExample07">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdown07" data-bs-toggle="dropdown" aria-expanded="false">Catégories</a>
                                <ul class="dropdown-menu" aria-labelledby="dropdown07">
                                <li><a class="dropdown-item" href="#">Pull</a></li>
                                <li><a class="dropdown-item" href="#">Tee-shirt</a></li>
                                <li><a class="dropdown-item" href="#">Manteau</a></li>
                                </ul>
                            </li>
                        </ul>
                        <form>
